    ...
    <div class="container">
      ...
      <div class="edit-content clearfix">
        ...
        <div class="edit-box clearfix">
          <p>安装日期</p>
          <div class="edit-box-input">
            <el-date-picker v-model="deviceInfo.installDate" type="datetime" placeholder="选择日期时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
          </div>
        </div>
        <div class="edit-box clearfix">
          <p><span>*</span>监测对象</p>
        ...
        <div class="edit-box clearfix">
          <p>添加属性</p>
          <div class="edit-box-input">
            <el-input v-model="deviceInfo.deviceExtend" placeholder=""></el-input>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      deviceInfo: {
        ...
        "elevatorId": "dt001",
        "installDate": "",
        "createDate": "2019-04-22 17:58:46",
        "deviceExtend": ""
      },
  ...
  methods: {
    ...
    submit() {
      ...
      console.log(this.deviceInfo.installDate)
      let obj = {
        ...
        "monitorContent": this.monitorContent + "",
        "elevatorId": this.deviceInfo.elevatorId,
        "installDate": this.deviceInfo.installDate,
        "deviceExtend": this.deviceInfo.deviceExtend
      }
      console.log(obj)

      let url = 'http://192.168.100.89:9090/gi/test/device'
