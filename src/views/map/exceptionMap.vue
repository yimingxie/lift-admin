    ...
    <div class="row" >
      <div class="panel" style="padding:0">
        <div class="regionArea">
          ...
          处理进度 : &nbsp;&nbsp;&nbsp;
          <radio-group :items="periods" :value.sync="period" style=" display: inline-block;">></radio-group>
          <span class="today">
      ...
      function funcreateMakers() {
          ...
          for (var i = 0, marker; i < lnglats.length; i++) { // 故障检修
              if(lnglats[i].type === 2){
                ...
                var circles = new CircleShow(20, 4, lnglats[i].position, {fillColor:'red',fillOpacity:0.5});
                ...
                var circles = new CircleShow(20, 4, lnglats[i].position, {fillColor:'blue',fillOpacity:0.5});
                ...
                var circles = new CircleShow(20, 4, lnglats[i].position, {fillColor:'green',fillOpacity:0.5});
