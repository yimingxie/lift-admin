<template>
<div id="login" style="border:2px solid red;">
	
    <div style="border:2px solid blue;height:500px;margin:0 auto;width:70%;padding:20px 0 20px 80px;position:relative;">
      <div style="border:2px solid #4fbc40;width:370px;height:300px;padding:20px;display:inline-block"></div>
      <div style="border:2px solid #4fbc40;width:540px;height:300px;padding:20px;position:absolute;right:80px;top:20px"></div>
    </div>
